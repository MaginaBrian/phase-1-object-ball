...
function gameObject() {
  ...
  function playerNumbers(teamName) {
    ...
    for (const team in game) {
      if (game[team].teamName === teamName) {
        const players = game[team].players;
        return Object.keys(players).map(player => players[player].number);
      }
    }
  }
  ...
  console.log("Nets colors:", teamColors("Brooklyn Nets")); 
  console.log("Team names:", teamNames()); 
  console.log("Nets numbers:", playerNumbers("Brooklyn Nets")); 
